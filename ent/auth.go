...
func (e AuthEdges) RolesOrErr() ([]*Role, error) {
	if e.loadedTypes[0] {
		return e.Roles, nil
	}
...
// QueryRoles queries the "roles" edge of the Auth entity.
func (a *Auth) QueryRoles() *RoleQuery {
	return NewAuthClient(a.config).QueryRoles(a)
}
