...
func VisibleFlg(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldVisibleFlg, v))
}
...
func VisibleFlgEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldVisibleFlg, v))
}

// VisibleFlgNEQ applies the NEQ predicate on the "visible_flg" field.
func VisibleFlgNEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldVisibleFlg, v))
}

// HasRoled applies the HasEdge predicate on the "roled" edge.
func HasRoled() predicate.Role {
...
// HasRoledWith applies the HasEdge predicate on the "roled" edge with a given conditions (other predicates).
func HasRoledWith(preds ...predicate.Student) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := newRoledStep()
...
func HasAuthWith(preds ...predicate.Auth) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := newAuthStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
