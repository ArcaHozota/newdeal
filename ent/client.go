...
// QueryToRoles queries the to_roles edge of a Auth.
func (c *AuthClient) QueryToRoles(a *Auth) *RoleQuery {
...
// QueryRoled queries the roled edge of a Role.
func (c *RoleClient) QueryRoled(r *Role) *StudentQuery {
	query := (&StudentClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := r.ID
		step := sqlgraph.NewStep(
...
// QueryAuth queries the auth edge of a Role.
func (c *RoleClient) QueryAuth(r *Role) *AuthQuery {
...
// QueryStudentRole queries the student_role edge of a Student.
func (c *StudentClient) QueryStudentRole(s *Student) *RoleQuery {
	query := (&RoleClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
