...
func (au *AuthUpdate) AddRoleIDs(ids ...int64) *AuthUpdate {
	au.mutation.AddRoleIDs(ids...)
	return au
}

// AddRoles adds the "roles" edges to the Role entity.
func (au *AuthUpdate) AddRoles(r ...*Role) *AuthUpdate {
...
func (au *AuthUpdate) ClearRoles() *AuthUpdate {
	au.mutation.ClearRoles()
	return au
}

// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (au *AuthUpdate) RemoveRoleIDs(ids ...int64) *AuthUpdate {
	au.mutation.RemoveRoleIDs(ids...)
	return au
}

// RemoveRoles removes "roles" edges to Role entities.
func (au *AuthUpdate) RemoveRoles(r ...*Role) *AuthUpdate {
	ids := make([]int64, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (auo *AuthUpdateOne) AddRoleIDs(ids ...int64) *AuthUpdateOne {
	auo.mutation.AddRoleIDs(ids...)
	return auo
}

// AddRoles adds the "roles" edges to the Role entity.
func (auo *AuthUpdateOne) AddRoles(r ...*Role) *AuthUpdateOne {
	ids := make([]int64, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
...
// ClearRoles clears all "roles" edges to the Role entity.
func (auo *AuthUpdateOne) ClearRoles() *AuthUpdateOne {
	auo.mutation.ClearRoles()
	return auo
}

// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (auo *AuthUpdateOne) RemoveRoleIDs(ids ...int64) *AuthUpdateOne {
	auo.mutation.RemoveRoleIDs(ids...)
	return auo
}

// RemoveRoles removes "roles" edges to Role entities.
func (auo *AuthUpdateOne) RemoveRoles(r ...*Role) *AuthUpdateOne {
	ids := make([]int64, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
