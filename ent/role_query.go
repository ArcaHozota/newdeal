...
func (rq *RoleQuery) QueryStudent() *StudentQuery {
...
func (rq *RoleQuery) WithStudent(opts ...func(*StudentQuery)) *RoleQuery {
	query := (&StudentClient{config: rq.config}).Query()
...
func (rq *RoleQuery) loadStudent(ctx context.Context, query *StudentQuery, nodes []*Role, init func(*Role), assign func(*Role, *Student)) error {
	...
	query.Where(predicate.Student(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.StudentColumn), fks...))
	}))
